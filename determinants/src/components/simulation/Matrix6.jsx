...
const Matrix6 = (props) => {
  ...
  const generateDeterminantContent = (matrix, step) => {
    ...
    sum[0] = calculateMult(
      1,
      calculateMult(calculateDeterminant(matrix1_1), <Calculator parametro1={matrix1_2} parametro2={4}/>)
    );
    sum[1] = calculateMult(
      -1,
      calculateMult(calculateDeterminant(matrix2_1), <Calculator parametro1={matrix2_2} parametro2={4}/>)
    );
    sum[2] = calculateMult(
      1,
      calculateMult(calculateDeterminant(matrix3_1), <Calculator parametro1={matrix3_2} parametro2={4}/>)
    );
    sum[3] = calculateMult(
      -1,
      calculateMult(calculateDeterminant(matrix4_1), <Calculator parametro1={matrix4_2} parametro2={4}/>)
    );
    sum[4] = calculateMult(
      1,
      calculateMult(calculateDeterminant(matrix5_1), <Calculator parametro1={matrix5_2} parametro2={4}/>)
    );
    sum[5] = calculateMult(
      -1,
      calculateMult(calculateDeterminant(matrix6_1), <Calculator parametro1={matrix6_2} parametro2={4}/>)
    );

    sum[6] = calculateMult(
      1,
      calculateMult(calculateDeterminant(matrix7_1), <Calculator parametro1={matrix7_2} parametro2={4}/>)
    );
    sum[7] = calculateMult(
      1,
      calculateMult(calculateDeterminant(matrix8_1), <Calculator parametro1={matrix8_2} parametro2={4}/>)
    );
    sum[8] = calculateMult(
      -1,
      calculateMult(calculateDeterminant(matrix9_1),<Calculator parametro1={matrix9_2} parametro2={4}/>)
    );
