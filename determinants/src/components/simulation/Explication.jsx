            ...
            case 16:
                return (
                    <div className="explication__step">
                      <p>
                        Ahora, se tiene toda la expansion de productos de determinantes
                        2x2 por determinante de 4x4, como se puede observar, se tienen los 15 productos, si no
                        recuerdas como se calculo, puedes regresar al inicio de la
                        simulación.
                      </p>
                      <br />
                      <p>
                        Como podemos ver, al tener un determinante de 4x4, necesitamos hacer uso del mismo algoritmo,
                        por lo que mostraremos como ejemplo solo el primer producto de determinantes, puedes elaborar los demás
                        colocandolos dentro de esta aplicación para observar el paso a paso de su desarrollo.
                      </p>
                    </div>
                  );
            case 17:
                return (
                    <div className="explication__step">
                      <p>
                        En la parte inferior podemos observar el producto de determinantes 2x2 por 4x4, donde procederemos a descomponer el determinante 
                        4x4 para poder hacer los calculos pertinentes, como se mencionó en el paso anterior únicamente se mostrara este producto de determinantes
                        posterior a ello solo se mostrará el resultado de dichos determinantes.
                      </p>
                    </div>
                  );
            /*case 10:
